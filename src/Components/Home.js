    ...
    return (
        <div className='homebox'>
            <div className='homebox-left'>
                ...
                <div>
                    <p className='home-description'>Whether yoou are a <span className="span-green">writer</span>, <span className="span-green">marketer</span>, or <span className="span-green">enterpreneur</span>,</p>
